...
import { FaEnvelope, FaLock, FaWallet, FaEye, FaEyeSlash, FaGoogle } from "react-icons/fa";
        ...
        <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-300">
          ...
          <div className="text-center mb-8 animate-slideUp">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              {isGoogleRegister ? "Complete your Google Registration" : "Welcome back! Please login to continue"}
            </p>
          </div>
          ...
          {isGoogleRegister ? (
            ...
            <form onSubmit={handleGoogleRegisterSubmit} className="space-y-6 animate-slideUp">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-750 transition-all cursor-pointer"
                >
                  Cancel
                </button>
              </div>
            ...
            <>
              ...
              <div id="google-signin-btn" className="w-full flex justify-center mb-6"></div>
