...
import { FaUser, FaLock, FaEnvelope, FaWallet, FaEye, FaEyeSlash, FaGoogle } from "react-icons/fa";

const Register = () => {
  const { register: registerUser, googleLogin, googleRegister } = useContext(AuthContext);
  const navigate = useNavigate();
  const [isLoading, setIsLoading] = useState(false);
  const [showPassword, setShowPassword] = useState(false);
  const [showConfirmPassword, setShowConfirmPassword] = useState(false);

  // Google Sign-In specific states
  ...
  // Load and render the Google Sign-in button
  useEffect(() => {
    const initGoogle = () => {
      if (window.google) {
        window.google.accounts.id.initialize({
          client_id: import.meta.env.VITE_GOOGLE_CLIENT_ID || "spend-smart-dev-placeholder-id.apps.googleusercontent.com",
  ...
  const handleGoogleRegisterSubmit = async (e) => {
    ...
    setIsLoading(true);
    const success = await googleRegister(chosenUsername, googleEmail, googleId, googleToken);
    setIsLoading(false);
        ...
        <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-300">
          ...
          <div className="text-center mb-8 animate-slideUp">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              {isGoogleRegister ? "Choose display name for your Google account" : "Sign up to start managing your finances"}
            </p>
          </div>

          {isGoogleRegister ? (
            /* Google Display Name Selection Form */
            <form onSubmit={handleGoogleRegisterSubmit} className="space-y-6 animate-slideUp">
              <div className="animate-fadeIn">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3.5 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                    placeholder="Enter display name"
                  />
                </div>
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  This is the name that will be used inside the application for your account.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-linear-to-r from-blue-500 to-purple-600 text-white font-semibold py-3.5 rounded-xl shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-75 transition-all cursor-pointer"
                >
                  Cancel
                </button>
              </div>
            ...
            <>
                ...
                <div className="animate-fadeIn" style={{ animationDelay: '0.4s' }}>
                  ...
                  <div className="relative group">
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 active:scale-95 cursor-pointer"
              ...
              {/* Divider */}
              <div className="my-6 flex items-center justify-between text-gray-500 dark:text-gray-400">
              ...
              <div id="google-signup-btn" className="w-full flex justify-center mb-6"></div>
